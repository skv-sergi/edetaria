        ...
        <div class="cart-dropdown">
            <div class="cart-dropdown-inner">
                ...
                <ul class="woocommerce-mini-cart cart_list product_list_widget ">
				    <li class="dropdown-cart-wrap woocommerce-mini-cart-item mini_cart_item">
						<a href="#" class="remove remove_from_cart_button" aria-label="Borrar este artículo">×</a>
                            <a class="wc-thumb-title" href="#">
								<img src="assets/images/vins/via-terra-blanc.jpg" alt="Edetària">Via Terra Blanc
				            </a>
				        <span class="quantity">1 × <span class="woocommerce-Price-amount amount">290,00<span class="woocommerce-Price-currencySymbol">€</span></span></span>
                    </li>
				    
				    <li class="dropdown-cart-wrap woocommerce-mini-cart-item mini_cart_item">
						<a href="#" class="remove remove_from_cart_button">×</a>							<a class="wc-thumb-title" href="#">
				                <img src="assets/images/vins/edetaria-seleccio-blanc.jpg" alt="Edetària">Edetària Selecció Blanc
				            </a>
				    ...
				    <li class="dropdown-cart-wrap woocommerce-mini-cart-item mini_cart_item">
						<a href="#" class="remove remove_from_cart_button">×</a>							<a class="wc-thumb-title" href="#">
								<img src="assets/images/vins/edetaria-dols.jpg" alt="Edetària">Via Edetana	
                            </a>
				    ...
				    <li class="dropdown-cart-wrap woocommerce-mini-cart-item mini_cart_item">
						<a href="#" class="remove remove_from_cart_button">×</a>							<a class="wc-thumb-title" href="#">
								<img src="assets/images/vins/via-edetana-blanc.jpg" alt="Edetària">La personal	
                            </a>
				        <span class="quantity">1 × <span class="woocommerce-Price-amount amount">200,00<span class="woocommerce-Price-currencySymbol">€</span></span></span>
				    </li>
				</ul>
                
                <p class="woocommerce-mini-cart__total total"><strong>Subtotal:</strong> <span class="woocommerce-Price-amount amount">765,00<span class="woocommerce-Price-currencySymbol">€</span></span></p>
                
                <p class="woocommerce-mini-cart__buttons buttons"><a href="#" class="button wc-forward">Veure el carret</a><a href="#" class="button checkout wc-forward">Finalitzar compra</a></p>
