...
?>
    ...
    <main class="halfmargin">
        ...
        <section class="intro wrapper wrapper-margin">
            ...
            <h1>El celler</h1>
            <h2><em>Quan estimes un territori hi vius en sintonia</em></h2>
        ...
        <section class="page-wrapper">
                ...
                <div class="image">
                    <div class="slider">
                        <div class="flexslider-page">
                            <ul class="slides">
                                <li><img src="assets/images/page-elceller-2.jpg" alt="Edetària - El Celler" width="900" height="520" /></li>
                                <li><img src="assets/images/page-elceller-verema-1.jpg" alt="Edetària - El Celler" width="900" height="520" /></li>
                                <li><img src="assets/images/page-elceller-verema-2.jpg" alt="Edetària - El Celler" width="900" height="520" /></li>
                            </ul>
                        </div> <!-- /.flexslider-page -->
                    </div> <!-- /.slider -->
                </div>
            ...
            <div class="spotlight reverse" id="vinificacions">
                <div class="image">
                    <img src="assets/images/page-elceller-4.jpg" alt="Edetària - El Celler" width="900" height="520" />
                </div>
            ...
            <div class="spotlight" id="criansa">
                <div class="image">
                    <img src="assets/images/page-elceller-3.jpg" alt="Edetària - El Celler" width="900" height="520" />
                </div>
