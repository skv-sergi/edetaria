...
if ($Fish_n_Ships->im_pro()) {
	...
	<div id="wc-fns-freemium-panel" class="free-version ' . ($options['close_freemium'] < time() ? 'opened' : 'closed') . '">
		...
		<p>' . esc_html__('This plugin is free and updates through the standard WordPress plugins repository. This free version have some features limited.', 'fish-and-ships') . '</p>
		<div class="can_close">
		<p>' . wp_kses(
				__('There is a <strong>professional</strong> version with amazing extra features. It works in the same way as free version, simply give you more options: New <strong>selection methods</strong>, the ability of set <strong>different group criteria</strong> on every selection, much more <strong>special actions</strong> and of course, upgrades and prioritary support.', 'fish-and-ships'),
				 array('strong'=>array())
				) . '</p>
		<p>' . esc_html__('You can take a look about this, compare free vs pro features, license prices and conditions, etc. here:', 'fish-and-ships') . '</p>
		</div>
		</div>
