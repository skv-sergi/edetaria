<?php /* Template Name: Pàgina Press Room */ get_header(); ?>
    ...
    <main class="nomargin">
        ...
        <?php if (have_posts()) : ?>
        <?php query_posts(array( 'post_type' => 'pressroom', 'orderby' => 'menu_order', 'order' => 'ASC', 'posts_per_page' => 24, 'paged' => $paged )); ?>
        <?php while (have_posts()) : the_post(); ?>
        <section class="wrapper wrapper-margin wrapper-posts">
            <div class="spotlight">
                    ...
                    <article class="content post download-post">
                        ...
                        <div class="entry-excerpt clearfix">
                            ...
                            <?php if (qtranxf_getLanguage()=='ca'): ?>
                                ...
                                <?php elseif( get_field('document_esp') ): ?>
                                    <a href="<?php the_field('document_esp'); ?>" class="more-link" target="_blank">
                                    Descarregar arxiu 
                                    <span class="meta-nav">↓</span></a>
                                <?php elseif( get_field('document_eng') ): ?>
                                    <a href="<?php the_field('document_eng'); ?>" class="more-link" target="_blank">
                                    Descarregar arxiu 
                                    <span class="meta-nav">↓</span></a>
                                <?php else: ?>
                            ...
                            <?php if (qtranxf_getLanguage()=='es'): ?>
                                ...
                                <?php if( get_field('document_esp') ): ?>
                                    <a href="<?php the_field('document_esp'); ?>" class="more-link" target="_blank">
                                    Descargar archivo 
                                    <span class="meta-nav">↓</span></a>
                                <?php elseif( get_field('link_del_document') ): ?>
                                    <a href="<?php the_field('link_del_document'); ?>" class="more-link" target="_blank">
                                    Descargar archivo 
                                    <span class="meta-nav">↓</span></a>
                                <?php elseif( get_field('document_eng') ): ?>
