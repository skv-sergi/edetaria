            ...
            <div class="spotlight bottom-footer">
                <div class="footer-left">
                    <ul class="footer-menu">
                        ...
                        <li><a href="/contacte/">Contacte</a><span>Veniu o contacteu-nos del del nostre formulari.</span></li>
                    </ul>
                </div>
                <div class="footer-right">
                    <?php footer_nav(); ?>
                    <span class="rights">
                            © <?php echo date("Y"); ?> Edetària | <a href="<?php bloginfo('home') ?>/wp-admin">Admin</a> | Disseny: <a href="https://sokvist.com" target="_blank">Sokvist</a>
                    </span>
                </div>
            </div>
